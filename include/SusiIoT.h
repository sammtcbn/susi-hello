...
typedef unsigned int       uint32_t;    //sam+
...
#define SUSI_IOT_ID_LIB 0x00000100
#define SUSI_IOT_ID_LIB_VERSION 0x00000101
#define SUSI_IOT_ID_LIB_CAPABILITY 0x00000102
